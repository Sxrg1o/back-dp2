...
CREATE INDEX idx_pedprod_creado_por      ON pedido_producto (creado_por);
CREATE INDEX idx_pedprod_modificado_por  ON pedido_producto (modificado_por);
...
CREATE INDEX idx_divcta_creado_por      ON division_cuenta (creado_por);
CREATE INDEX idx_divcta_modificado_por  ON division_cuenta (modificado_por);
...
CREATE INDEX idx_divdet_creado_por     ON division_cuenta_detalle (creado_por);
CREATE INDEX idx_divdet_modificado_por ON division_cuenta_detalle (modificado_por);
