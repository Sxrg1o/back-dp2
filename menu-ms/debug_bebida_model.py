#!/usr/bin/env python3
"""
Script para debuggear específicamente la conversión de bebidas desde el modelo.
"""

def test_bebida_model():
    """Prueba específicamente la conversión de bebidas desde el modelo."""
    print("🔍 DEBUGGING CONVERSIÓN DE BEBIDAS DESDE MODELO")
    print("="*50)
