#!/usr/bin/env python3
"""
Script para debuggear específicamente el método to_domain() del modelo.
"""

def test_model_to_domain():
    """Prueba específicamente el método to_domain() del modelo."""
    print("🔍 DEBUGGING MÉTODO to_domain() DEL MODELO")
    print("="*50)
